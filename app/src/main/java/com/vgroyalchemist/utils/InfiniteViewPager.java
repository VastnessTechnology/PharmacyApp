...
public class InfiniteViewPager extends ViewPager {
    ...
    private static class MyHandler extends Handler {
        ...
        public MyHandler(InfiniteViewPager ref) {
            this.ref = new WeakReference<InfiniteViewPager>(ref);
        }
...
//                log("onPageSelected:" + position);
                System.out.println("onPageScrolled_onPageScrolled_2222");
                startAutoScroll();
                getParent().requestDisallowInterceptTouchEvent(false);
...
//                    System.out.println("motion_evevnt_action_move111.............." + action);
//                    return false;
//                case MotionEvent.ACTION_UP:
//                    System.out.println("motion_evevnt_action_move222.............." + action);
//                    break;
//
//            }
//        }
...
//    }
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        setFakeCurrentItem(FakePositionHelper.getRealPositon(InfiniteViewPager.this, 0), true);
    }
