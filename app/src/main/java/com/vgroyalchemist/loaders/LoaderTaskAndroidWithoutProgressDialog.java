 ...
 */
public class LoaderTaskAndroidWithoutProgressDialog<T extends TaskExecutor> extends AsyncTaskLoader<TaskExecutor> {

    private TaskExecutor executor;
//    TransparentProgressDialog progressDialog;
    private Context context;

    public LoaderTaskAndroidWithoutProgressDialog(Context context, TaskExecutor executor) {
        super(context);
