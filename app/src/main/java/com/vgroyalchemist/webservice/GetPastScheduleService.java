...
import com.vgroyalchemist.requestobjects.GetPastScheduleInfo;
...
public class GetPastScheduleService {
    ...
    public JSONObject generateRequestJSON(String mStringUserId ,String currentDate) {
        ...
        GetPastScheduleInfo getActiveScheduleInfo = new GetPastScheduleInfo(mStringUserId ,currentDate);
        try {
    ...
    public ServerResponseVO getAllSchedule(Context context, String url, String mStringUserId ,String currentDate) {
        ...
        try {
            ...
            Utility.debugger("VT Get Past Schedule url....." + url);
            Utility.debugger("VT Get Past Schedule request....." + requestJSON);
            Utility.debugger("VT Get Past Schedule.... " + responseJSON);
...
//
                try {
                    ...
                    for (int A = 0; A < jsonArray.length(); A++) {
                        ...
                        try {
                            scheduleActiveVO.setColourcode(jsonArrayJSONObject.getString("colourcode"));
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
