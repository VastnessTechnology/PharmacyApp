...
import com.vgroyalchemist.requestobjects.ShowAllVitalListTimeInfo;
...
public class ShowAllVitalListTimeService {

    public JSONObject generateRequestJSON(String mStringUserid,String mStringVitalId ,String mStringVitalDate) {

        JSONObject requestObject = null;
        JSONObject mObject = null;
        RequestFactory mRequestFactory = new RequestFactory();
        ShowAllVitalListTimeInfo listInfo = new ShowAllVitalListTimeInfo(mStringUserid,mStringVitalId ,mStringVitalDate);
        try {
    ...
    public ServerResponseVO vitalListTime(Context context, String url ,String mStringUserid,String mStringVitalId ,String mStringVitalDate) {
        ServerResponseVO serverResponseVO = new ServerResponseVO();

        try {
            JSONObject requestJSON = generateRequestJSON(mStringUserid,mStringVitalId,mStringVitalDate);
