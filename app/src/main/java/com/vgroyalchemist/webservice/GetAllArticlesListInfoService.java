...
public class GetAllArticlesListInfoService {

    public JSONObject generateRequestJSON(String mStringUserid , String mStringDeviceToken) {

        JSONObject requestObject = null;
        JSONObject mObject = null;
        RequestFactory mRequestFactory = new RequestFactory();
        GetAllArticlesListInfo searchMedicineInfo = new GetAllArticlesListInfo(mStringUserid ,mStringDeviceToken);
        try {
    ...
    public ServerResponseVO fetchLoginUserInformation(Context context, String url,String mStringUserid , String mStringDeviceToken) {
        ServerResponseVO serverResponseVO = new ServerResponseVO();

        try {
            JSONObject requestJSON = generateRequestJSON(mStringUserid ,mStringDeviceToken);

            JSONObject responseJSON = sendRequest(url, requestJSON, context);
            Utility.debugger("VT Articles List....." + url);
            Utility.debugger("VT Articles List......" + requestJSON);
            Utility.debugger("VT responseJSON  Articles List..... " + responseJSON);
